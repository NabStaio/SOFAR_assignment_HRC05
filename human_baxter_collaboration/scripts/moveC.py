...
#############################################################################################
#_SCRIPT FOR MOVING THE LEFT ARM AND PICK CUBE C:                                           #
# This script is needed in order to pick the cube C on the left side of the table.          #
# It's needed because the cube C is on two red cubes that if human takes them the position  #
# of C floating in space, so baxter has bugs                                                #
#############################################################################################
...
def move_left(cube):
    ...
    pose_goal.position.x = my_data[frame].pose.position.x  
    pose_goal.position.y = my_data[frame].pose.position.y 
    pose_goal.position.z = my_data[frame].pose.position.z 
    ...
    pose_goal.position.x = my_data[24].pose.position.x - 0.03
